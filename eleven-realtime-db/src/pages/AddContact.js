...
const AddContact = () => {
  ...
  const imagePicker = async (e) => {
    ...
    try {
      ...
      uploadTask.on(
        ...
        (snapshot) => {
          ...
          switch (snapshot.state) {
            ...
            case firebase.storage.TaskState.RUNNING:
              console.log("Uploading is in running state");
              break;
          }
        ...
        (err) => {
          console.log(err);
          toast("something went wrong in state", { type: "error" });
        },
        () => {
          uploadTask.snapshot.ref
            ...
            .catch((err) => {
              console.log(err);
              toast("error in getting downloaded url", { type: "error" });
            });
        }
      );
    } catch (error) {
  ...
  const addContact = async () => {
    ...
    try {
      ...
      console.log(error);
      toast("Error in Adding Contact", { type: "error" });
    }
  };
  ...
  const updateContact = async () => {
    ...
    try {
      ...
      console.log(error);
      toast("Error in Updating Contact", { type: "error" });
    }
  };
